-- Complete Import Script - Removes ALL constraints temporarily

-- Step 1: Drop ALL constraints that might block import
ALTER TABLE post_statuses DROP CONSTRAINT IF EXISTS post_statuses_user_id_fkey;
...
ALTER TABLE recurring_actions DROP CONSTRAINT IF EXISTS recurring_actions_user_id_fkey;
ALTER TABLE recurring_actions DROP CONSTRAINT IF EXISTS recurring_actions_action_type_check;
ALTER TABLE social_media_posts DROP CONSTRAINT IF EXISTS social_media_posts_user_id_fkey;
ALTER TABLE social_media_posts DROP CONSTRAINT IF EXISTS social_media_posts_recurring_action_id_fkey;
...
DELETE FROM authors;
DELETE FROM pillars;
DELETE FROM post_statuses;

-- Step 4: Import post_statuses
INSERT INTO post_statuses (id, user_id, name, color, is_active, created_at, updated_at) VALUES
('6c48fa7a-71f6-4426-a535-f7770faf9ffa', '7c0da4a2-3786-4070-bad9-42c17b417935', 'nezahájeno', '#6B7280', true, '2026-01-16T08:24:35.47434+00:00', '2026-01-16T08:24:35.47434+00:00'),
('00a8124a-c0c1-416d-80e7-526ead0fd1fc', '7c0da4a2-3786-4070-bad9-42c17b417935', 'v procesu', '#ff9500', true, '2026-01-16T08:24:58.703808+00:00', '2026-01-16T08:24:58.703808+00:00'),
('e0023ecb-b520-436d-9771-27b4b4ccd33f', '7c0da4a2-3786-4070-bad9-42c17b417935', 'publikováno', '#99ff00', true, '2026-01-16T08:25:20.797488+00:00', '2026-01-16T08:25:20.797488+00:00');

-- Step 5: Import pillars
INSERT INTO pillars (id, user_id, name, color, is_active, created_at, updated_at) VALUES
('9851d639-d34d-4894-8607-91a520bbcaf2', '7c0da4a2-3786-4070-bad9-42c17b417935', 'Herbateka', '#f64f3c', true, '2026-01-15T08:30:06.76509+00:00', '2026-01-15T08:30:06.76509+00:00'),
('c3b4d188-7068-4469-abd5-1c292f36ae5c', '7c0da4a2-3786-4070-bad9-42c17b417935', 'Recept', '#ff007b', true, '2026-01-15T08:30:19.08049+00:00', '2026-01-15T08:30:19.08049+00:00'),
('b7c740f1-e90f-48b2-b9ee-54e791f09176', '7c0da4a2-3786-4070-bad9-42c17b417935', 'Novinka', '#3B82F6', true, '2026-01-15T08:30:27.774594+00:00', '2026-01-15T08:30:27.774594+00:00'),
('d8abf6a6-bf4c-4a58-beb4-567f206fe9b5', '7c0da4a2-3786-4070-bad9-42c17b417935', 'Video', '#fff700', true, '2026-01-15T08:53:01.97341+00:00', '2026-01-15T08:53:01.97341+00:00');

-- Step 6: Import authors
INSERT INTO authors (id, user_id, name, initials, email, color, is_active, created_at, updated_at) VALUES
('04f7d4f9-33e9-4976-8b95-5f6d2e2adb1a', '7c0da4a2-3786-4070-bad9-42c17b417935', 'Honza', 'HON', 'honza.hrodek@gmail.com', '#3B82F6', true, '2026-01-15T08:27:34.833433+00:00', '2026-01-15T08:27:34.833433+00:00');

-- Step 7: Import recurring_actions
INSERT INTO recurring_actions (id, user_id, action_type, title, description, data, color, order_index, frequency, created_at, updated_at) VALUES
('8f530850-1af7-4d74-84f9-ee0cba81622b', '7c0da4a2-3786-4070-bad9-42c17b417935', 'monthly', 'Recept Volfová', '', '{}'::jsonb, '#6366f1', 0, '1x monthly', '2026-01-15T08:21:33.044745+00:00', '2026-01-15T08:21:33.044745+00:00'),
('b1bef619-0260-4032-8a81-d85dc09d4366', '7c0da4a2-3786-4070-bad9-42c17b417935', 'quarterly', 'Soutěž', '', '{"prize":"","hashtag":"","mechanics":"","platforms":"","announcement_date":""}'::jsonb, '#6366f1', 0, '1x monthly', '2026-01-15T08:34:01.753679+00:00', '2026-01-15T08:34:10.942+00:00'),
('4e3424be-2f61-4dc9-b0fa-a1c3342849aa', '7c0da4a2-3786-4070-bad9-42c17b417935', 'weekly', 'Pinterest', '', '{}'::jsonb, '#6366f1', 0, '1x', '2026-01-16T10:17:55.008435+00:00', '2026-01-16T10:18:09.076+00:00'),
('30e46668-4a0d-4603-b96e-9f6fd03b981f', '7c0da4a2-3786-4070-bad9-42c17b417935', 'weekly', 'Facebook a instagram post', '', '{}'::jsonb, '#6366f1', 0, '2x', '2026-01-15T08:33:01.297575+00:00', '2026-01-16T10:12:06.929+00:00'),
('9e93bfb2-b1a1-4a9c-8592-bb6ff7b930db', '7c0da4a2-3786-4070-bad9-42c17b417935', 'monthly', 'Youtube video', '', '{}'::jsonb, '#6366f1', 0, '1x', '2026-01-16T10:51:00.775665+00:00', '2026-01-16T10:51:00.775665+00:00');

-- Step 8: Import social_media_posts
...
VALUES
('ae888cb8-4b7f-4ced-8cb5-c2a468fb779c', '7c0da4a2-3786-4070-bad9-42c17b417935', 'Akce darek zdarma', 'facebook', '2026-01-18T23:00:00+00:00', 'draft', '2026-01-15T08:51:44.250776+00:00', '2026-01-15T08:51:44.250776+00:00'),
('0968d86f-eb3b-4ac0-927f-7cc2db265167', '7c0da4a2-3786-4070-bad9-42c17b417935', 'Video Mexico', 'facebook', '2026-01-18T23:00:00+00:00', 'draft', '2026-01-15T08:50:51.90597+00:00', '2026-01-15T08:50:51.90597+00:00');
...
-- Step 10: Update RLS policies to allow all access (for development)
...
CREATE POLICY "Allow all on recurring_actions" ON recurring_actions FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all on pillars" ON pillars FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all on post_statuses" ON post_statuses FOR ALL USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow all on authors" ON authors FOR ALL USING (true) WITH CHECK (true);
